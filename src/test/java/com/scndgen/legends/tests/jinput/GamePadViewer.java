...
Every DELAY ms the game pad is polled (using JenesisGamePad),
        ...
        rumblerCheck.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent ie) {
                if (ie.getStateChange() == ItemEvent.SELECTED) {
                    JenesisGamePad.getInstance().setRumbler(true, 0.8f);  // switch on
                } else // deselected
                {
                    JenesisGamePad.getInstance().setRumbler(false, 0.0f);  // switch off
                }
            }
        });
        c.add(rumblerCheck);
    ...
    event-dispatching thread. */ {
        ActionListener pollPerformer = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int compassDir = JenesisGamePad.getInstance().getHatDir();
                ...
                // get button settings
                boolean[] buttons = JenesisGamePad.getInstance().getButtons();
