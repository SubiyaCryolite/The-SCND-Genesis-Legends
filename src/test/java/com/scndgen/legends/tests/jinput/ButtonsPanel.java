...
/* A collection of JenesisGamePad.NUM_BUTTONS textfields
...
public class ButtonsPanel extends JPanel {
     ...
     */ {
        ...
        buttonTFs = new JTextField[JenesisGamePad.NUM_BUTTONS];
        for (int i = 0; i < JenesisGamePad.NUM_BUTTONS; i++) {
        ...
        makeRow(0, JenesisGamePad.NUM_BUTTONS / 2);   // 1st row
        makeRow(JenesisGamePad.NUM_BUTTONS / 2, JenesisGamePad.NUM_BUTTONS);  // 2nd row
    }  // end of ButtonsPanel()
     ...
     */ {
        if (bVals.length != JenesisGamePad.NUM_BUTTONS) {
