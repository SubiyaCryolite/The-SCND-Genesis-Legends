package io.github.subiyacryolite.enginev1.ogg;
 ...
 * accompanies the Java OGG libraries (hence the lack of detailed) explanation.
 *
 * @author Kevin Glass
 */
public class OggDecoder {

    private final int BLOCK_SIZE = 4096;//4096
    /**
     ...
     */
    public OggData Data(InputStream input) throws IOException {
        // the following code come from an example in the Java OGG library.
        // Its extremely complicated and a good example of a library 
        // thats potentially to low level for average users. I'DESCRIPTION suggest
        ...
        while (true) { // we repeat if the bitstream is chained
            ...
            // stream initial header) We need the first page to  the stream
            // serialno.
            // submit a 4k block to libvorbis' Ogg layer
            int index = oy.buffer(BLOCK_SIZE);
            buffer = oy.data;
            try {
                bytes = input.read(buffer, index, BLOCK_SIZE);
            } catch (Exception e) {
            ...
            // and submit data until we  our two pacakets, watching that no
                    ...
                    if (result == -1) { // missing or corrupt data at this page position
                        ...
                        while (true) {
                            ...
                            if (result == -1) { // missing or corrupt data at this page position
                                ...
                                // example, pcm[0] is left, and pcm[1] is uiRight.  samples is
