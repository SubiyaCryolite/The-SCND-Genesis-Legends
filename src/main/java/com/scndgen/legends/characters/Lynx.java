...
public class Lynx extends Character {
    ...
    public void attack(String attack, PlayerType playerType, GamePlay gamePlay) {
        switch (attack) {
            case "01" -> strike(gamePlay, playerType, physical[0], 100);
            case "02" -> strike(gamePlay, playerType, physical[1], 98);
            case "03" -> strike(gamePlay, playerType, physical[2], 97);
            case "04" -> strike(gamePlay, playerType, physical[3], 96);
            case "05" -> strike(gamePlay, playerType, celestia[0], 98);
            case "06" -> strike(gamePlay, playerType, celestia[1], 97);
            case "07" -> strike(gamePlay, playerType, celestia[2], 103);
            case "08" -> strike(gamePlay, playerType, celestia[3], 100);
